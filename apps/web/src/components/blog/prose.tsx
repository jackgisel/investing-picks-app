...
export function InlineCTA({
  ...
  return (
    <div className="my-12 soft-card max-w-[680px]">
      <p className="font-sans text-[11px] font-bold tracking-[0.14em] uppercase text-text mb-3">
        OUTPICK MEMBERSHIP
      </p>
    ...
    <div className="my-12 max-w-[680px]">
      ...
      <div className="border-t border-border">
        {items.map((item, i) => (
          ...
          >
            <summary className="font-sans text-[15px] font-semibold text-text cursor-pointer list-none flex items-start justify-between gap-4 group-hover:opacity-70 transition-opacity">
              <span>{item.q}</span>
