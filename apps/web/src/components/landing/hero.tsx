    ...
    <section className="relative py-16 sm:py-24 overflow-hidden">
      <div className="container-op">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            <div className="mb-8 hero-reveal hero-reveal-1">
              <OutpickWordmark size={22} />
            </div>

            <h1 className="font-sans text-[34px] sm:text-[44px] font-extrabold leading-[1.15] mb-5 tracking-tight max-w-[540px] hero-reveal hero-reveal-2">
              {SITE_TAGLINE}
            </h1>

            <p className="font-sans text-[16px] sm:text-[17px] text-text-muted max-w-[460px] mb-10 leading-relaxed hero-reveal hero-reveal-3">
              {SITE_SUBHEADLINE}
            </p>
