...
export function FridayStockPickPanel() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <p className="panel-label mb-2">Friday Stock Pick</p>
        <p className="max-w-[640px] font-sans text-[13px] leading-relaxed text-text-dim">
