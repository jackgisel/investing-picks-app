    ...
    <section className="relative">
      ...
      >
        <Image
          ...
          priority
          sizes="100vw"
          className="object-cover object-[72%_38%] sm:object-[75%_34%] lg:object-[78%_32%]"
        />
      ...
      <div className="relative container-op py-20 pb-16 sm:py-28 sm:pb-20 lg:min-h-[min(88vh,860px)] lg:py-36 lg:pb-24">
        <div className="relative max-w-[540px]">
          ...
          <p className="font-sans text-[16px] sm:text-[17px] text-text-muted mb-5 leading-relaxed hero-reveal hero-reveal-2">
          ...
          <p className="mb-8 font-sans text-[13px] text-text-dim hero-reveal hero-reveal-2 lg:hidden">
